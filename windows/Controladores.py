...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Pmao = QtWidgets.QPushButton(self.centralwidget)
        self.Pmao.setGeometry(QtCore.QRect(10, 450, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.Pmao.setFont(font)
        self.Pmao.setObjectName("Pmao")
        self.PDmao = QtWidgets.QPushButton(self.centralwidget)
        self.PDmao.setGeometry(QtCore.QRect(10, 500, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.PDmao.setFont(font)
        self.PDmao.setObjectName("PDmao")
        self.PMatLab = QtWidgets.QPushButton(self.centralwidget)
        self.PMatLab.setGeometry(QtCore.QRect(10, 550, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.PMatLab.setFont(font)
        self.PMatLab.setObjectName("PMatLab")
        self.PDMatLab = QtWidgets.QPushButton(self.centralwidget)
        self.PDMatLab.setGeometry(QtCore.QRect(10, 600, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.PDMatLab.setFont(font)
        self.PDMatLab.setObjectName("PDMatLab")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Pmao.setText(_translate("MainWindow", "P"))
        self.PDmao.setText(_translate("MainWindow", "PD"))
        self.PMatLab.setText(_translate("MainWindow", "P - MatLab"))
        self.PDMatLab.setText(_translate("MainWindow", "PD - MatLab"))
