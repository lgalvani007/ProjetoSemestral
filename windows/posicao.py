...
class Ui_Posicao(object):
    def setupUi(self, Posicao):
        ...
        self.Status = QtWidgets.QLabel(Posicao)
        ...
        self.Salvar = QtWidgets.QPushButton(Posicao)
    ...
    def retranslateUi(self, Posicao):
        ...
        Posicao.setWindowTitle(_translate("Posicao", "Posição"))
        ...
        self.Status.setText(_translate("Posicao", "TextLabel"))
        self.Salvar.setText(_translate("Posicao", "Salvar"))
